...
#вторую одним ходом. В случае, если хотя бы одно из введенных чисел не лежит в диапазоне от 1 до 8, выведите строку "Ошибка!".
...
if not 0<(x1)<9 and not 0<(x2)<9 and not 0<(y1)<9 and not 0<(y2)<9:
    print('ошибка')
elif (abs(x2-x1)==1 or abs(x2-x1)==2) and (abs(y2-x1)==1 or abs(y2-y1)==2):
    print('да')
else:
    print('нет')